...
export async function getBstrsrIn(media) {
    ...
    const tvshowUrl = `https://bstsrs.in/show/${media.title.replaceAll(" ", "-").toLowerCase()}-s${season.toString().padStart(2, '0')}e${episode.toString().padStart(2, '0')}/season/${season}/episode/${episode}`;    
